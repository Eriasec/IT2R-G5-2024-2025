...
osThreadDef (GUIThread, osPriorityAboveNormal, 1, 2048);   // thread object
...
void InitCan1 (void) {
	Driver_CAN1.Initialize(myCAN1_callback,myCAN1_callback);
	...
	Driver_CAN1.ObjectSetFilter( 0,
																...
																ARM_CAN_STANDARD_ID(0x0F6),
																0);			

	Driver_CAN1.ObjectConfigure(1,ARM_CAN_OBJ_TX); // Objet 1pour émission
	Driver_CAN1.ObjectConfigure(0,ARM_CAN_OBJ_RX); // Objet 0pour réception
	Driver_CAN1.SetMode(ARM_CAN_MODE_NORMAL);	// fin init
}
//void InitCan2 (void) 
//	{
//	Driver_CAN2.Initialize(myCAN2_callback,myCAN2_callback);
...
//        ARM_CAN_BIT_SJW(1U)
//    );
//    	Driver_CAN2.ObjectSetFilter( 0,
//																ARM_CAN_FILTER_ID_EXACT_ADD,
//																ARM_CAN_STANDARD_ID(0x0F6),
//																0);	
//  	Driver_CAN2.ObjectConfigure(1,ARM_CAN_OBJ_TX); // Objet 1pour émission
//	  Driver_CAN2.ObjectConfigure(0,ARM_CAN_OBJ_RX); // Objet 0pour réception
...
osThreadDef(CANthreadR,osPriorityBelowNormal, 1,0);
osThreadDef(CANthreadT,osPriorityBelowNormal, 1,0);
